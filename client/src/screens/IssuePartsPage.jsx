...
export default function IssuePartsPage() {
  ...
  const [requestorEmployeeNumber, setRequestorEmployeeNumber] = useState('');
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto w-full">
      <div>
        ...
        <div className="text-sm text-slate-600">Search a part, capture job details, quantities and signatures.</div>
      </div>

      <form className="space-y-6" onSubmit={handleSubmit}>
        <div className="rounded-xl bg-white shadow-soft p-6 space-y-3">
          <div className="text-sm font-semibold text-epiroc-blue">1. Select part</div>
        ...
        <div className="rounded-xl bg-white shadow-soft p-6 space-y-4">
          <div className="text-sm font-semibold text-epiroc-blue">2. Job information</div>
        ...
        <div className="rounded-xl bg-white shadow-soft p-6 space-y-4">
          <div className="text-sm font-semibold text-epiroc-blue">3. Requestor & quantity</div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
            ...
            <div>
              <label className="text-sm font-medium text-slate-700">Employee number (optional)</label>
              <input className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2" value={requestorEmployeeNumber} onChange={(e) => setRequestorEmployeeNumber(e.target.value)} />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="text-sm font-medium text-slate-700">Quantity requested</label>
              <input
            ...
            <div>
              <label className="text-sm font-medium text-slate-700">Quantity issued</label>
              <input
                className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2"
                type="number"
                min="0"
            ...
            <div>
              <label className="text-sm font-medium text-slate-700">Quantity to order</label>
              <input
                className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2"
                type="number"
                min="0"
          ...
          <div className="text-xs text-slate-500">
            Quantity issued and quantity to order are calculated automatically from stock on hand, but can be adjusted before submitting.
          </div>
        </div>
